...
def extract_wikipedia_data(urls):
    ...
    for url in urls:
        ...
        if response.status_code == 200:
            ...
            question = f"¿Qué es {title}?"
            data.append({'question': question, 'answer': normalized_text})
        else:
...
if __name__ == "__main__":
    ...
    output_directory = "D:\PROYECTOS\PYHTON-PROJECTS\data"
